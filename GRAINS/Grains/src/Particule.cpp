...
void Particule::printAllParticleInfos(char* filename=NULL)
{
  if (filename!=NULL)
  {
    ofstream file;
    ...
    file << std::fixed << m_id ;
    file << ",";
    file << std::fixed << m_tag ;
    file << ",";
    file << std::fixed << m_type ;
    file << ",";
    file << std::fixed << m_ParticuleClasse ;
    file << ",";
    file << std::fixed << m_GeoLoc ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_masse ;
    file << ",";
    // file << std::fixed << std::setprecision(15) << m_weight ;
    // file << ",";
    // position
    const Point* pos;
    pos = getPosition();
    file << std::fixed << std::setprecision(15) << (*pos)[0] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << (*pos)[1] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << (*pos)[2] ;
    file << ",";
    // angular position
    Matrix orientation;
    orientation = (m_geoFormeVdw)->getOrientation();
    file << std::fixed << std::setprecision(15) << orientation[0][0] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[0][1] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[0][2] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[1][0] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[1][1] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[1][2] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[2][0] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[2][1] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << orientation[2][2] ;
    file << ",";
    // velocity
    const Vecteur* v;
    v = getVitesseTranslation();
    file << std::fixed << std::setprecision(15) << (*v)[0] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << (*v)[1] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << (*v)[2] ;
    file << ",";
    // angular velocity
    v = getVitesseRotation();
    file << std::fixed << std::setprecision(15) << (*v)[0] ;
    file << ",";
    file << std::fixed << std::setprecision(15) << (*v)[1] ;
    file << ",";
    ...
    for(int i=0; i<6; i++)
    {
      file << std::fixed << std::setprecision(15) << m_inertie[i] ;
      file << ",";
    }
    // inverse of inertia matrix
    for(int i=0; i<6; i++)
    {
      file << std::fixed << std::setprecision(15) << m_inertie_1[i] ;
      file << ",";
    }
    // internal moments
    file << std::fixed << std::setprecision(15) << m_mxx ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_mxy ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_mxz ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_myx ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_myy ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_myz ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_mzx ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_mzy ;
    file << ",";
    file << std::fixed << std::setprecision(15) << m_mzz ;
    file << ",";
    // other infos
    file << std::fixed << std::setprecision(15) << m_energie ;
    file << ",";
    file << std::fixed << is_mobile ;
    file << ",";
    file << std::fixed << m_activity ;
    file << ",";
    file << std::fixed << m_coordination_number ;
    file << "/";
    file.close();
  }
  else
