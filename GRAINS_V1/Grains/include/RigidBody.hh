...
{ 
  public:
    ...
    RigidBody( Convex* convex_, Transform const& position_ );

    /** @brief Copy constructor
    @param form copied RigidBody object */
    RigidBody( RigidBody const& form );
    ...
    rotation 
    @param trot transformation à appliquer */  
