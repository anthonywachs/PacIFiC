...
sed -i 's|${GRAINS_HOME}/XERCES-2.8.0|/media/data/softwares/XERCES-2.8.0|' GRAINS/Env/grains_default.env.sh
sed -i 's|${GRAINS_HOME}/XERCES-2.8.0|/media/data/softwares/XERCES-2.8.0|' GRAINS/Env/grains_default.env.csh
