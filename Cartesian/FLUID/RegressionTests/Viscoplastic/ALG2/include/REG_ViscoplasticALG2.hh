#ifndef REG_VISCOPLASTIC_ALG2_HH
#define REG_VISCOPLASTIC_ALG2_HH
...
/** @brief The Class REG_ViscoplasticALG2.

Solver for the incompressible viscoplastic NavierStokes problem. 

@author A. Wachs - Pacific project 2018-2019 */

class REG_ViscoplasticALG2 : public FV_OneStepIteration, public ComputingTime,
public SolverComputingTime
{
   ...
   //-- Constructors & Destructor
      ...
      //@{
      /** @brief Destructor */          
      ~REG_ViscoplasticALG2( void ) ;
     
      /** @brief Copy constructor */      
      REG_ViscoplasticALG2( REG_ViscoplasticALG2 const& other ) ;
      
      /** @brief Operator == 
      @param other the right hand side */        
      REG_ViscoplasticALG2& operator=( REG_ViscoplasticALG2 const& other ) ;
      
      /** @brief Constructor with arguments 
      @param a_owner the PEL-based object   
      @param dom mesh and fields
      @param exp to read the data file */                 
      REG_ViscoplasticALG2( MAC_Object* a_owner, 
      ...
      @param dom mesh and fields
      @param exp to read the data file */
      virtual REG_ViscoplasticALG2* create_replica( 
		MAC_Object* a_owner,
		FV_DomainAndFields const* dom,
   ...
   //-- Class attributes
      ...
      static REG_ViscoplasticALG2 const* PROTOTYPE ;
   ...
   //-- Attributes
      ...
      REG_ViscoplasticALG2System* GLOBAL_EQ ;      
