#ifndef REG_VISCOPLASTIC_FISTA_HH
#define REG_VISCOPLASTIC_FISTA_HH
...
/** @brief The Class REG_ViscoplasticFISTA.
...
public SolverComputingTime
{
   ...
   //-- Constructors & Destructor
      ...
      //@{
      /** @brief Destructor */          
      ~REG_ViscoplasticFISTA( void ) ;
     
      /** @brief Copy constructor */      
      REG_ViscoplasticFISTA( REG_ViscoplasticFISTA const& other ) ;
      
      /** @brief Operator == 
      @param other the right hand side */        
      REG_ViscoplasticFISTA& operator=( REG_ViscoplasticFISTA const& other ) ;
      
      /** @brief Constructor with arguments 
      @param a_owner the PEL-based object   
      @param dom mesh and fields
      @param exp to read the data file */                 
      REG_ViscoplasticFISTA( MAC_Object* a_owner, 
      ...
      @param dom mesh and fields
      @param exp to read the data file */
      virtual REG_ViscoplasticFISTA* create_replica( 
		MAC_Object* a_owner,
		FV_DomainAndFields const* dom,
   ...
   //-- Class attributes
      ...
      static REG_ViscoplasticFISTA const* PROTOTYPE ;
   ...
   //-- Attributes
      ...
      REG_ViscoplasticFISTASystem* GLOBAL_EQ ;      
      ...
      double FISTA_tolerance;
      size_t FISTA_maxiter;
      size_t d_level ;
      size_t D_level ;
