...
//--------------------------------------------------------------------------- 
{
  ...
  out << space << "Gravity center = " << m_gravity_center << endl;
  ...
  out << space << "Translational velocity = " << m_translational_velocity << 
  	endl; 
  out << space << "Angular velocity = " << m_angular_velocity << endl; 	
  out << space << "Hydrodynamic force = " << m_hydro_force << endl;
  out << space << "Hydrodynamic torque = " << m_hydro_torque << endl;
  out << space << "Temperature = " << m_temperature << endl;  	
  out << space << "Heat flux = " << m_heat_flux << endl;
  if ( m_periodic_directions )
  {
