...
//---------------------------------------------------------------------------
{
  MAC_LABEL( "FS_3Dcylinder:: distanceTo( pt, direction, positive )" ) ;
