   ...
   , Solver_Temperature ( 0 )
{
   ...
   struct NavierStokes2System inputDataNS;
   inputDataNS.is_solids_ = is_solids ; 
   inputDataNS.is_stressCal_ = is_stressCal ;
   inputDataNS.Npart_ = Npart ;
   inputDataNS.level_set_type_ = level_set_type ;
   inputDataNS.Npoints_ = Npoints ;
   inputDataNS.ar_ = ar ;

   // Build the matrix system
   MAC_ModuleExplorer* se = exp->create_subexplorer( 0,"DDS_NSWithHeatTransferSystem" ) ;
   GLOBAL_EQ = DDS_NSWithHeatTransferSystem::create( this, se, UF, PF, inputDataNS ) ;
   se->destroy() ;
...
//---------------------------------------------------------------------------
{
   ...
   if (is_solids) {
	 ...
	 if (my_rank == 0) {
	    ...
	    particle_information = local_par_info.str();
	 }

	 // Broadcasting the particle info from root(0) to rest of the processor
	 pelCOMM->broadcast(particle_information,0);
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: import_par_info( size_t const& field, istringstream &is )
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: simulate_GRAINS( void )
//---------------------------------------------------------------------------
{
   MAC_LABEL( "DDS_NSWithHeatTransfer:: simulate_GRAINS" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: initialize_GRAINS( void )
//---------------------------------------------------------------------------
{
   MAC_LABEL( "DDS_NSWithHeatTransfer:: initialize_GRAINS" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: error_with_analytical_solution_poiseuille3D ( )
//---------------------------------------------------------------------------
{
   MAC_LABEL("DDS_NSWithHeatTransfer:: error_with_analytical_solution_poiseuille3D" ) ;
...
//---------------------------------------------------------------------------
{
   MAC_LABEL("DDS_NSWithHeatTransfer:: error_with_analytical_solution_poiseuille" ) ;
...
//---------------------------------------------------------------------------
double
DDS_NSWithHeatTransfer:: level_set_derivative (FV_DiscreteField const* FF, size_t const& m, size_t const& comp, double const& xC, double const& yC, double const& zC, string const& type, size_t const& field, size_t const& partial_dir)
//---------------------------------------------------------------------------
{
  MAC_LABEL( "DDS_NSWithHeatTransfer:: level_set_derivative" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: WriteSolidsInString ()
//---------------------------------------------------------------------------
{
  MAC_LABEL( "DDS_NSWithHeatTransfer:: WriteSolidsInString" ) ;
  ...
  for (size_t i=0;i<Npart;i++) {
     ...
     wx = solid.ang_vel[0]->item(i,0);
     wy = solid.ang_vel[0]->item(i,1);
     wz = solid.ang_vel[0]->item(i,2);
     Tp = solid.temp[0]->item(i);
     off = solid.inside[0]->item(i);
  ...
  particle_information = particles_features.str();
}
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: generate_list_of_local_particles (FV_DiscreteField const* FF, size_t const& field )
//---------------------------------------------------------------------------
{
  MAC_LABEL( "DDS_NSWithHeatTransfer:: generate_list_of_local_particles" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: unpack_ue(size_t const& comp, double * received_data, size_t const& dir, size_t const& p, size_t const& field)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: second_order_pressure_stress(class doubleArray2D& force, size_t const& parID, size_t const& Np )
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: second_order_pressure_stress" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: second_order_pressure_stress_withNeumannBC(class doubleArray2D& force, size_t const& parID, size_t const& Np)
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: second_order_pressure_stress_withNeumannBC" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: first_order_pressure_stress(class doubleArray2D& force, size_t const& parID, size_t const& Np) 
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: first_order_pressure_stress" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: compute_fluid_particle_interaction( FV_TimeIterator const* t_it)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: compute_surface_points_on_cube(size_t const& Np)
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSwithHeatTransfer:: compute_surface_points_on_cube" ) ;
/*
  ofstream outputFile ;
  std::ostringstream os2;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: compute_surface_points_on_cylinder(class doubleVector& k, size_t const& Nring)
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: compute_surface_points_on_cylinder" ) ;
/*
  ofstream outputFile ;
  std::ostringstream os2;
  os2 << "./DS_results/point_data_" << my_rank << ".csv";
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: compute_surface_points_on_sphere(class doubleVector& eta, class doubleVector& k, class doubleVector& Rring, size_t const& Nring)
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: compute_surface_points_on_sphere" ) ;
/*
  ofstream outputFile ;
  std::ostringstream os2;
  os2 << "./DS_results/point_data_" << my_rank << ".csv";
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: generate_surface_discretization()
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: generate_surface_discretization" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: ghost_points_generation( FV_DiscreteField* FF, class doubleArray2D& point, class size_t_array2D& i0, int const& sign, size_t const& comp,size_t const& major_dir, class boolArray2D& point_in_domain, class doubleVector& rotated_vector )
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: ghost_points_generation" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: compute_pressure_force_on_particle(class doubleArray2D& force, size_t const& parID, size_t const& Np )
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: compute_velocity_force_on_particle(class doubleArray2D& force, size_t const& parID, size_t const& Np )
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: second_order_viscous_stress(class doubleArray2D& force, size_t const& parID, size_t const& Np )
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: second_order_viscous_stress" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: first_order_viscous_stress(class doubleArray2D& force, size_t const& parID, size_t const& Np )
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: first_order_visous_stress" ) ;
...
//---------------------------------------------------------------------------
double
DDS_NSWithHeatTransfer:: quadratic_interpolation3D ( FV_DiscreteField* FF, size_t const& comp, double const& xp, double const& yp, double const& zp, size_t const& ii, size_t const& ji, size_t const& ki, size_t const& ghost_points_dir, class intVector& sign, size_t const& level)
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: quadratic_interpolation3D" ) ;
...
//---------------------------------------------------------------------------
double
DDS_NSWithHeatTransfer:: third_order_ghost_field_estimate ( FV_DiscreteField* FF, size_t const& comp, double const& xp, double const& yp, double const& zp, size_t const& ii, size_t const& ji, size_t const& ki, size_t const& ghost_points_dir, class intVector& sign, size_t const& level)
//---------------------------------------------------------------------------
{
   MAC_LABEL("DDS_NSWithHeatTransfer:: third_order_ghost_field_estimate" ) ;
...
//---------------------------------------------------------------------------
void
DDS_NSWithHeatTransfer:: gen_dir_index_of_secondary_ghost_points (FV_DiscreteField* FF, class size_t_vector& index, class intVector& sign, size_t const& interpol_dir, class size_t_array2D& index_g, class boolVector& point_in_domain, size_t const& comp)
//---------------------------------------------------------------------------
{
  MAC_LABEL("DDS_NSWithHeatTransfer:: gen_dir_index_of_secondary_ghost_points" ) ;
...
//---------------------------------------------------------------------------
double
DDS_NSWithHeatTransfer:: quadratic_interpolation2D ( FV_DiscreteField* FF, size_t const& comp, double const& xp, double const& yp, double const& zp, size_t const& i0, size_t const& j0, size_t const& k0, size_t const& interpol_dir, class intVector& sign, size_t const& level)
//---------------------------------------------------------------------------
{
   MAC_LABEL("DDS_NSWithHeatTransfer:: quadratic_interpolation2D" ) ;
...
//----------------------------------------------------------------------
double
DDS_NSWithHeatTransfer:: divergence_of_U( size_t const& i, size_t const& j, size_t const& k, size_t const& component, size_t const& level)
//----------------------------------------------------------------------
{
   MAC_LABEL( "DDS_NSWithHeatTransfer:: divergence_of_U" );
