...
//---------------------------------------------------------------------------
void
DDS_NavierStokes:: node_property_calculation (FV_DiscreteField const* FF)
//---------------------------------------------------------------------------
{
  ...
  node_old.void_frac->set(node.void_frac);
  node_old.parID->set(node.parID);
           ...
           for (size_t k=local_min_k;k<=local_max_k;++k) {
              ...
              for (size_t m=0;m<Npart;m++) {
                 ...
                 //if (level_set <= 1.E-1*dh) {
                    ...
                    node.parID->set_item(p,(double)m);
                    break;
                 }
              }
           }
