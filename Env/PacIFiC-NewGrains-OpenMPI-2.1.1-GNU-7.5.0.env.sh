...
# MPI
export PACIFIC_MPI_ROOT=/home/damien/softwares/openmpi-2.1.1/build
...
export PACIFIC_SERCOMPIL_VERSION="9.4.0"
...
# Grains
source ${PACIFIC_HOME}/GRAINS_V1/Env/grains-${PACIFIC_MPI_DISTRIB}-${PACIFIC_MPI_VERSION}-${PACIFIC_SERCOMPIL_ENV}-${PACIFIC_SERCOMPIL_VERSION}.env.sh
echo -e '  '
