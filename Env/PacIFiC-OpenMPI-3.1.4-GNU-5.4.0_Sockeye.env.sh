...
# PacIFiC home
export PACIFIC_HOME=${HOME}/PacIFiC-Git/pacific
...
# MPI
export PACIFIC_MPI_ROOT=/arc/software/spack/opt/spack/linux-centos7-x86_64/gcc-5.4.0/openmpi-3.1.4-4z5imzdrviicq3catx7cizfklyc64t6h
export PACIFIC_MPI_DISTRIB=OpenMPI
export PACIFIC_MPI_VERSION="3.1.4"
...
export PACIFIC_SERCOMPIL_VERSION="5.4.0"
...
export PACIFIC_BLAS_LIBDIR=/arc/software/spack/opt/spack/linux-centos7-x86_64/gcc-5.4.0/intel-mkl-2019.3.199-qpd5enfzu4sjw2vkzfpdg5smqb3lmt2p/mkl/lib/intel64
export PACIFIC_BLAS_LIBS="mkl_blas95_lp64 mkl_intel_lp64 mkl_sequential mkl_core mkl_gf_lp64"
export PACIFIC_ATLAS_LIBDIR=/arc/software/spack/opt/spack/linux-centos7-x86_64/gcc-5.4.0/intel-mkl-2019.3.199-qpd5enfzu4sjw2vkzfpdg5smqb3lmt2p/mkl/lib/intel64
export PACIFIC_ATLAS_LIBS="mkl_blas95_lp64 mkl_intel_lp64 mkl_sequential mkl_core mkl_gf_lp64"
export PACIFIC_LAPACK_LIBDIR=/arc/software/spack/opt/spack/linux-centos7-x86_64/gcc-5.4.0/intel-mkl-2019.3.199-qpd5enfzu4sjw2vkzfpdg5smqb3lmt2p/mkl/lib/intel64
export PACIFIC_LAPACK_LIBS="mkl_lapack95_lp64 mkl_intel_lp64 mkl_sequential mkl_core mkl_gf_lp64"
export PACIFIC_GFORTRAN_LIBDIR=/arc/software/spack/opt/spack/linux-centos7-x86_64/gcc-4.8.5/gcc-5.4.0-mufy3fjs33jgj47lb3346bqktgtjnt4i/lib64
...
export PACIFIC_Z_DIR=/arc/software/spack/opt/spack/linux-centos7-x86_64/gcc-5.4.0/zlib-1.2.11-vgysup72xw64pyjyxkgxwjx5oucxoafi
export PACIFIC_Z_INCDIR="${PACIFIC_Z_DIR}/include"
export PACIFIC_Z_LIBDIR="${PACIFIC_Z_DIR}/lib"
export PACIFIC_X11_DIR=/usr
export PACIFIC_X11_INCDIR="${PACIFIC_X11_DIR}/include/X11 ${PACIFIC_X11_DIR}/include/X11/Xmu"
